 ...
 */
class Excerpt extends BaseExcerpt
{
    ...
    /**
     * Duplicate from Bolt\Helpers\Excerpt because of private...
     *
     ...
     * @return string
     */
    protected function extractRelevant($words, $fulltext, $relLength = 300)
    {
        if (!is_array($words)) {
            $words = explode(' ', $words);
        }
